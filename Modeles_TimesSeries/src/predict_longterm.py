...
def predict_longterm(historique_path, nb_annees=3, batch_size=1000, 
                     ...
                     model_dir="models/saved", config_path="config/config.yaml"):
    """
    ...
    if 'jour_ferie' not in historique_48h.columns:
        historique_48h['jour_ferie'] = 0
    
    historique_48h = historique_48h[['datetime', 'puissance_kw', 'temperature', 'humidite', 'jour_ferie']]
...
def save_longterm_predictions(df_predictions, output_path=None, config_path="config/config.yaml"):
    """
...
if __name__ == "__main__":
    ...
    print(f"\n🎉 Prédictions long terme terminées !")
